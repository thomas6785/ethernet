...
module mem_to_wo_mem #(
    parameter RESPONSE_TO_READ = 64'hBADD_BADD_BADD_BADD // what to put on rdata in response to a read transaction. Usually ignored but can be used to supply an error code to the master
) (
    input clk_i,
    input rst_ni,
